...
declare namespace angular.translate {
    ...
    interface ITranslatePartialLoaderProvider extends IServiceProvider, IPartialLoader<ITranslatePartialLoaderProvider> {
        setPart(lang : string, part : string, table : ITranslationTable) : ITranslatePartialLoaderProvider;
    }

    interface ITranslateService {
        (translationId: string, interpolateParams?: any, interpolationId?: string): IPromise<string>;
        (translationId: string[], interpolateParams?: any, interpolationId?: string): IPromise<{ [key: string]: string }>;
        ...
        refresh(langKey?: string): IPromise<void>;
        storage(): IStorage;
        storageKey(): string;
        use(): string;
        use(key: string): IPromise<string>;
        useFallbackLanguage(langKey?: string): void;
        versionInfo(): string;
        loaderCache(): any;
        isReady(): boolean;
        onReady(): IPromise<void>;
        resolveClientLocale():string;
    }

    interface ITranslateProvider extends IServiceProvider {
